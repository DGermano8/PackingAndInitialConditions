#ifndef PeriodicStromalBoxBoundaryCondition3dIncreasingDomain_HPP_
#define PeriodicStromalBoxBoundaryCondition3dIncreasingDomain_HPP_
 ...
 */
class PeriodicStromalBoxBoundaryCondition3dIncreasingDomain : public AbstractCellPopulationBoundaryCondition<3>
{
private:
...
public:
     ...
     */
	PeriodicStromalBoxBoundaryCondition3dIncreasingDomain(AbstractCellPopulation<3>* pCellPopulation);

    /**
     * Destructor.
     */
    ~PeriodicStromalBoxBoundaryCondition3dIncreasingDomain();
...
//EXPORT_TEMPLATE_CLASS_SAME_DIMS(PeriodicStromalBoxBoundaryCondition3dIncreasingDomain)
...
{
/**
 * Serialize information required to construct a PeriodicStromalBoxBoundaryCondition3dIncreasingDomain.
 */
template<class Archive>
inline void save_construct_data(
    Archive & ar, const PeriodicStromalBoxBoundaryCondition3dIncreasingDomain * t, const unsigned int file_version)
{
...
/**
 * De-serialize constructor parameters and initialize a PeriodicStromalBoxBoundaryCondition3dIncreasingDomain.
 */
template<class Archive>
inline void load_construct_data(
    Archive & ar, PeriodicStromalBoxBoundaryCondition3dIncreasingDomain * t, const unsigned int file_version)
{
    ...
    ::new(t)PeriodicStromalBoxBoundaryCondition3dIncreasingDomain(p_cell_population);
}
}
} // namespace ...

#endif /*PeriodicStromalBoxBoundaryCondition3dIncreasingDomain_HPP_*/
