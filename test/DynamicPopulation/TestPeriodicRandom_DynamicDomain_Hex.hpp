...
public:
    ...
    void TestPeriodicCubeWithGhosts() throw (Exception)
    {
        ...
        std::string output_directory = "Packing/Random_Dynamic_Sorting_Hex/Noise_0";
        ...
        double start_increase_domain_time = end_time;       			      
        double end_increase_domain_time = end_time+10.0;
        double domain_increase = 0.0;
